...
func (mg *Broker) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this Broker.
func (mg *Broker) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *Broker) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this Broker.
func (mg *Broker) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
