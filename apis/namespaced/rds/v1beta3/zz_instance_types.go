...
type InstanceInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ReplicateSourceDBRef *v1.NamespacedReference `json:"replicateSourceDbRef,omitempty" tf:"-"`

	// Selector for a Instance in rds to populate replicateSourceDb.
	// +kubebuilder:validation:Optional
	ReplicateSourceDBSelector *v1.NamespacedSelector `json:"replicateSourceDbSelector,omitempty" tf:"-"`
