...
type EndpointDetailsInitParameters struct {
	...
	AddressAllocationIdsRefs []v1.NamespacedReference `json:"addressAllocationIdsRefs,omitempty" tf:"-"`

	// Selector for a list of EIP in ec2 to populate addressAllocationIds.
	// +kubebuilder:validation:Optional
	AddressAllocationIdsSelector *v1.NamespacedSelector `json:"addressAllocationIdsSelector,omitempty" tf:"-"`
...
type ServerInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	LoggingRoleRef *v1.NamespacedReference `json:"loggingRoleRef,omitempty" tf:"-"`

	// Selector for a Role in iam to populate loggingRole.
	// +kubebuilder:validation:Optional
	LoggingRoleSelector *v1.NamespacedSelector `json:"loggingRoleSelector,omitempty" tf:"-"`

	// Specify a string to display when users connect to a server. This string is displayed after the user authenticates. The SFTP protocol does not support post-authentication display banners.
	PostAuthenticationLoginBannerSecretRef *v1.LocalSecretKeySelector `json:"postAuthenticationLoginBannerSecretRef,omitempty" tf:"-"`

	// Specify a string to display when users connect to a server. This string is displayed before the user authenticates.
	PreAuthenticationLoginBannerSecretRef *v1.LocalSecretKeySelector `json:"preAuthenticationLoginBannerSecretRef,omitempty" tf:"-"`
