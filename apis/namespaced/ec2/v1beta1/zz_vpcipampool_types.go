...
type VPCIpamPoolInitParameters struct {
	...
	IpamScopeIDRef *v1.NamespacedReference `json:"ipamScopeIdRef,omitempty" tf:"-"`

	// Selector for a VPCIpamScope in ec2 to populate ipamScopeId.
	// +kubebuilder:validation:Optional
	IpamScopeIDSelector *v1.NamespacedSelector `json:"ipamScopeIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SourceIpamPoolIDRef *v1.NamespacedReference `json:"sourceIpamPoolIdRef,omitempty" tf:"-"`

	// Selector for a VPCIpamPool in ec2 to populate sourceIpamPoolId.
	// +kubebuilder:validation:Optional
	SourceIpamPoolIDSelector *v1.NamespacedSelector `json:"sourceIpamPoolIdSelector,omitempty" tf:"-"`
