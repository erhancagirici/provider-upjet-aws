...
type SecurityGroupIngressRuleInitParameters struct {
	...
	PrefixListIDRef *v1.NamespacedReference `json:"prefixListIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	ReferencedSecurityGroupIDRef *v1.NamespacedReference `json:"referencedSecurityGroupIdRef,omitempty" tf:"-"`

	// Selector for a SecurityGroup in ec2 to populate referencedSecurityGroupId.
	// +kubebuilder:validation:Optional
	ReferencedSecurityGroupIDSelector *v1.NamespacedSelector `json:"referencedSecurityGroupIdSelector,omitempty" tf:"-"`
