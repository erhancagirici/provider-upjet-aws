...
type EcsClusterLayerInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	CustomSecurityGroupIDRefs []v1.NamespacedReference `json:"customSecurityGroupIdRefs,omitempty" tf:"-"`

	// Selector for a list of SecurityGroup in ec2 to populate customSecurityGroupIds.
	// +kubebuilder:validation:Optional
	CustomSecurityGroupIDSelector *v1.NamespacedSelector `json:"customSecurityGroupIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	EcsClusterArnRef *v1.NamespacedReference `json:"ecsClusterArnRef,omitempty" tf:"-"`

	// Selector for a Cluster in ecs to populate ecsClusterArn.
	// +kubebuilder:validation:Optional
	EcsClusterArnSelector *v1.NamespacedSelector `json:"ecsClusterArnSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/namespaced/opsworks/v1beta1.Stack
