...
type InstanceInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/namespaced/opsworks/v1beta1.CustomLayer
	LayerIds []*string `json:"layerIds,omitempty" tf:"layer_ids,omitempty"`

	// References to CustomLayer in opsworks to populate layerIds.
	// +kubebuilder:validation:Optional
	LayerIdsRefs []v1.NamespacedReference `json:"layerIdsRefs,omitempty" tf:"-"`

	// Selector for a list of CustomLayer in opsworks to populate layerIds.
	// +kubebuilder:validation:Optional
	LayerIdsSelector *v1.NamespacedSelector `json:"layerIdsSelector,omitempty" tf:"-"`
