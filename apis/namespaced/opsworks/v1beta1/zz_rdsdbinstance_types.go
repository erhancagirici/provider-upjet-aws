...
type RDSDBInstanceInitParameters struct {
	...
	RDSDBInstanceArnRef *v1.NamespacedReference `json:"rdsDbInstanceArnRef,omitempty" tf:"-"`

	// Selector for a Instance in rds to populate rdsDbInstanceArn.
	// +kubebuilder:validation:Optional
	RDSDBInstanceArnSelector *v1.NamespacedSelector `json:"rdsDbInstanceArnSelector,omitempty" tf:"-"`
