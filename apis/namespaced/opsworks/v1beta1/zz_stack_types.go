...
type StackInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	DefaultInstanceProfileArnRef *v1.NamespacedReference `json:"defaultInstanceProfileArnRef,omitempty" tf:"-"`

	// Selector for a InstanceProfile in iam to populate defaultInstanceProfileArn.
	// +kubebuilder:validation:Optional
	DefaultInstanceProfileArnSelector *v1.NamespacedSelector `json:"defaultInstanceProfileArnSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	DefaultSubnetIDRef *v1.NamespacedReference `json:"defaultSubnetIdRef,omitempty" tf:"-"`

	// Selector for a Subnet in ec2 to populate defaultSubnetId.
	// +kubebuilder:validation:Optional
	DefaultSubnetIDSelector *v1.NamespacedSelector `json:"defaultSubnetIdSelector,omitempty" tf:"-"`
