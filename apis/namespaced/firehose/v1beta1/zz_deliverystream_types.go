...
type DestinationTableConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/namespaced/glue/v1beta1.CatalogTable
...
type ElasticsearchConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/namespaced/elasticsearch/v1beta1.Domain
	...
	// +kubebuilder:validation:Optional
	DomainArnRef *v1.NamespacedReference `json:"domainArnRef,omitempty" tf:"-"`

	// Selector for a Domain in elasticsearch to populate domainArn.
	// +kubebuilder:validation:Optional
	DomainArnSelector *v1.NamespacedSelector `json:"domainArnSelector,omitempty" tf:"-"`
...
type OpensearchserverlessConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/namespaced/opensearchserverless/v1beta1.Collection
	...
	// +kubebuilder:validation:Optional
	CollectionEndpointRef *v1.NamespacedReference `json:"collectionEndpointRef,omitempty" tf:"-"`

	// Selector for a Collection in opensearchserverless to populate collectionEndpoint.
	// +kubebuilder:validation:Optional
	CollectionEndpointSelector *v1.NamespacedSelector `json:"collectionEndpointSelector,omitempty" tf:"-"`
...
type SnowflakeConfigurationInitParameters struct {
	...
	KeyPassphraseSecretRef *v1.LocalSecretKeySelector `json:"keyPassphraseSecretRef,omitempty" tf:"-"`
