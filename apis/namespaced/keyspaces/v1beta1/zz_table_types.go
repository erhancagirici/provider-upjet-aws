...
type TableInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/namespaced/keyspaces/v1beta1.Keyspace
	...
	// +kubebuilder:validation:Optional
	KeyspaceNameRef *v1.NamespacedReference `json:"keyspaceNameRef,omitempty" tf:"-"`

	// Selector for a Keyspace in keyspaces to populate keyspaceName.
	// +kubebuilder:validation:Optional
	KeyspaceNameSelector *v1.NamespacedSelector `json:"keyspaceNameSelector,omitempty" tf:"-"`
