...
type PlatformApplicationInitParameters struct {
	...
	FailureFeedbackRoleArnRef *v1.NamespacedReference `json:"failureFeedbackRoleArnRef,omitempty" tf:"-"`

	// Selector for a Role in iam to populate failureFeedbackRoleArn.
	// +kubebuilder:validation:Optional
	FailureFeedbackRoleArnSelector *v1.NamespacedSelector `json:"failureFeedbackRoleArnSelector,omitempty" tf:"-"`
	...
	PlatformCredentialSecretRef v1.LocalSecretKeySelector `json:"platformCredentialSecretRef" tf:"-"`

	// Application Platform principal. See Principal for type of principal required for platform.
	PlatformPrincipalSecretRef *v1.LocalSecretKeySelector `json:"platformPrincipalSecretRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SuccessFeedbackRoleArnRef *v1.NamespacedReference `json:"successFeedbackRoleArnRef,omitempty" tf:"-"`

	// Selector for a Role in iam to populate successFeedbackRoleArn.
	// +kubebuilder:validation:Optional
	SuccessFeedbackRoleArnSelector *v1.NamespacedSelector `json:"successFeedbackRoleArnSelector,omitempty" tf:"-"`
