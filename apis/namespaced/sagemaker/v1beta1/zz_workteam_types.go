...
type CognitoMemberDefinitionInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/namespaced/cognitoidp/v1beta1.UserGroup
...
type WorkteamInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/namespaced/sagemaker/v1beta1.Workforce
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/pkg/resource.ExtractResourceID()
