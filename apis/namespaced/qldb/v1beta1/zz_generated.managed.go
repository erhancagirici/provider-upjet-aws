...
func (mg *Ledger) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this Ledger.
func (mg *Ledger) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *Ledger) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this Ledger.
func (mg *Ledger) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
