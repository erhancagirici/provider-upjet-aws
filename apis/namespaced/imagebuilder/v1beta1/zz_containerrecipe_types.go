...
type ContainerRecipeComponentInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/namespaced/imagebuilder/v1beta1.Component
...
type TargetRepositoryInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/namespaced/ecr/v1beta1.Repository
