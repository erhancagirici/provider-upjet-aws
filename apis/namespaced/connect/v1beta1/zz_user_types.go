...
type UserInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/namespaced/connect/v1beta1.RoutingProfile
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/namespaced/connect/v1beta1.SecurityProfile
