...
type CredentialsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	CopySourceArnRef *v1.NamespacedReference `json:"copySourceArnRef,omitempty" tf:"-"`

	// Selector for a DataSource in quicksight to populate copySourceArn.
	// +kubebuilder:validation:Optional
	CopySourceArnSelector *v1.NamespacedSelector `json:"copySourceArnSelector,omitempty" tf:"-"`
...
type VPCConnectionPropertiesInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/namespaced/quicksight/v1beta1.VPCConnection
	// +crossplane:generate:reference:extractor=github.com/upbound/provider-aws/v2/config/namespaced/common.ARNExtractor()
	...
	// +kubebuilder:validation:Optional
	VPCConnectionArnRef *v1.NamespacedReference `json:"vpcConnectionArnRef,omitempty" tf:"-"`

	// Selector for a VPCConnection in quicksight to populate vpcConnectionArn.
	// +kubebuilder:validation:Optional
	VPCConnectionArnSelector *v1.NamespacedSelector `json:"vpcConnectionArnSelector,omitempty" tf:"-"`
}
