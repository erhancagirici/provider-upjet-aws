...
func (mg *NetworkPerformanceMetricSubscription) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this NetworkPerformanceMetricSubscription.
func (mg *NetworkPerformanceMetricSubscription) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *NetworkPerformanceMetricSubscription) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this NetworkPerformanceMetricSubscription.
func (mg *NetworkPerformanceMetricSubscription) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
