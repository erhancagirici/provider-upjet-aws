...
func (mg *ScalingPlan) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this ScalingPlan.
func (mg *ScalingPlan) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *ScalingPlan) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this ScalingPlan.
func (mg *ScalingPlan) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
