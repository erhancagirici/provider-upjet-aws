...
func (mg *ProfilingGroup) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this ProfilingGroup.
func (mg *ProfilingGroup) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *ProfilingGroup) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this ProfilingGroup.
func (mg *ProfilingGroup) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
