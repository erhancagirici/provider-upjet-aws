...
type OrderedCacheBehaviorFunctionAssociationInitParameters struct {
	...
	// ARN of the CloudFront function.
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/cloudfront/v1beta1.Function
...
type OriginInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/cloudfront/v1beta1.OriginAccessControl
...
type S3OriginConfigInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/cloudfront/v1beta1.OriginAccessIdentity
