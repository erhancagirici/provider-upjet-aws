...
type ActionsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/cluster/glue/v1beta1.Crawler
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/cluster/glue/v1beta1.Job
