...
type DestinationTableConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/cluster/glue/v1beta2.CatalogDatabase
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/cluster/glue/v1beta2.CatalogTable
...
type ElasticsearchConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/cluster/elasticsearch/v1beta1.Domain
...
type OpensearchConfigurationInitParameters struct {
	...
	// The ARN of the Amazon ES domain.  The pattern needs to be arn:.*.  Conflicts with cluster_endpoint.
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/cluster/opensearch/v1beta1.Domain
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/pkg/resource.ExtractParamPath("arn",true)
	DomainArn *string `json:"domainArn,omitempty" tf:"domain_arn,omitempty"`
...
type OpensearchserverlessConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/cluster/opensearchserverless/v1beta1.Collection
...
type SchemaConfigurationInitParameters struct {
	...
	// Specifies the AWS Glue table that contains the column information that constitutes your data schema.
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/cluster/glue/v1beta1.CatalogTable
	TableName *string `json:"tableName,omitempty" tf:"table_name,omitempty"`
