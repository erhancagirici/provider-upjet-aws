...
type CredentialsInitParameters struct {
	...
	// Reference to a DataSource in quicksight to populate copySourceArn.
	// +kubebuilder:validation:Optional
	CopySourceArnRef *v1.Reference `json:"copySourceArnRef,omitempty" tf:"-"`

	// Selector for a DataSource in quicksight to populate copySourceArn.
	// +kubebuilder:validation:Optional
	CopySourceArnSelector *v1.Selector `json:"copySourceArnSelector,omitempty" tf:"-"`
...
type VPCConnectionPropertiesInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/quicksight/v1beta1.VPCConnection
	// +crossplane:generate:reference:extractor=github.com/upbound/provider-aws/v2/config/cluster/common.ARNExtractor()
	VPCConnectionArn *string `json:"vpcConnectionArn,omitempty" tf:"vpc_connection_arn,omitempty"`

	// Reference to a VPCConnection in quicksight to populate vpcConnectionArn.
	// +kubebuilder:validation:Optional
	VPCConnectionArnRef *v1.Reference `json:"vpcConnectionArnRef,omitempty" tf:"-"`

	// Selector for a VPCConnection in quicksight to populate vpcConnectionArn.
	// +kubebuilder:validation:Optional
	VPCConnectionArnSelector *v1.Selector `json:"vpcConnectionArnSelector,omitempty" tf:"-"`
}
