...
type EcsTargetInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/cluster/ecs/v1beta1.TaskDefinition
...
type TargetInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/cluster/cloudwatchevents/v1beta1.Rule
