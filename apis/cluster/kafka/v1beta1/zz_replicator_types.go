...
type AmazonMskClusterInitParameters struct {
	...
	MskClusterArnRef *v1.Reference `json:"mskClusterArnRef,omitempty" tf:"-"`

	// Selector for a Cluster in kafka to populate mskClusterArn.
	// +kubebuilder:validation:Optional
	MskClusterArnSelector *v1.Selector `json:"mskClusterArnSelector,omitempty" tf:"-"`
}
...
type ReplicationInfoListInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SourceKafkaClusterArnRef *v1.Reference `json:"sourceKafkaClusterArnRef,omitempty" tf:"-"`

	// Selector for a Cluster in kafka to populate sourceKafkaClusterArn.
	// +kubebuilder:validation:Optional
	SourceKafkaClusterArnSelector *v1.Selector `json:"sourceKafkaClusterArnSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	TargetKafkaClusterArnRef *v1.Reference `json:"targetKafkaClusterArnRef,omitempty" tf:"-"`

	// Selector for a Cluster in kafka to populate targetKafkaClusterArn.
	// +kubebuilder:validation:Optional
	TargetKafkaClusterArnSelector *v1.Selector `json:"targetKafkaClusterArnSelector,omitempty" tf:"-"`
