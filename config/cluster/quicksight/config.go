...
func Configure(p *config.Provider) {
	...
	p.AddResourceConfigurator("aws_quicksight_custom_permissions", func(r *config.Resource) {
		r.AddSingletonListConversion("capabilities", "capabilities")
	})
	...
	p.AddResourceConfigurator("aws_quicksight_folder_membership", func(r *config.Resource) {
		r.AddSingletonListConversion("identities", "identities")
	...
	p.AddResourceConfigurator("aws_quicksight_refresh_schedule", func(r *config.Resource) {
		...
		r.AddSingletonListConversion("schedule", "schedule")
		r.AddSingletonListConversion("schedule[*].schedule_frequency", "schedule[*].scheduleFrequency")
		r.AddSingletonListConversion("schedule[*].schedule_frequency[*].refresh_on_day", "schedule[*].scheduleFrequency[*].refreshOnDay")
	})
