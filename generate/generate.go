...
//go:generate bash -c "find ../apis/cluster \\( -iname 'zz_generated.conversion_hubs.go' -o -iname 'zz_generated.conversion_spokes.go' -iname 'zz_generated.resolvers.go' \\) -delete"
//go:generate bash -c "find ../apis/cluster -iname 'zz_generated.resolvers.go' -delete"
//go:generate bash -c "find ../apis/cluster -type d -empty -delete"
...
// remove generated namespaced
//go:generate bash -c "find ../apis/namespaced \\( -iname 'zz_generated.conversion_hubs.go' -o -iname 'zz_generated.conversion_spokes.go' \\) -delete"
//go:generate bash -c "find ../apis/namespaced -iname 'zz_generated.resolvers.go' -delete"
//go:generate bash -c "find ../apis/namespaced -type d -empty -delete"
