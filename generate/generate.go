...
//go:generate go run github.com/crossplane/upjet/v2/cmd/resolver -g aws.upbound.io -a github.com/upbound/provider-aws/v2/internal/apis -s -p ../apis/cluster/...
//go:generate go run github.com/crossplane/upjet/v2/cmd/resolver -g aws.m.upbound.io -a github.com/upbound/provider-aws/v2/internal/apis -s -p ../apis/namespaced/...
