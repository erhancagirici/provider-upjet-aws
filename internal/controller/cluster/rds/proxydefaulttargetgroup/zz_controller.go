...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithLogger(o.Logger.WithValues("gvk", v1beta2.ProxyDefaultTargetGroup_GroupVersionKind)))
	...
	// register webhooks for the kind v1beta2.ProxyDefaultTargetGroup
	// if they're enabled.
	if o.StartWebhooks {
		if err := ctrl.NewWebhookManagedBy(mgr).
			For(&v1beta2.ProxyDefaultTargetGroup{}).
			Complete(); err != nil {
