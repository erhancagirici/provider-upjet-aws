...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithLogger(o.Logger.WithValues("gvk", v1beta2.Bucket_GroupVersionKind)))
	...
	// register webhooks for the kind v1beta2.Bucket
	// if they're enabled.
	if o.StartWebhooks {
