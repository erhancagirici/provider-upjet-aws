...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_opsworks(mgr, clusterOptions), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_opsworks(mgr, namespacedOptions), "Cannot setup namespaced AWS controllers")
